...
<body>
        ...
        <div class="container">
            ...
            <div class="header-right">
                <nav>
                    ...
                    <a href="kullanici_yazilar_sayfa.php">Yazılar</a>
    ...
    <div class="content">
        <div class="div_title">
            ...
            <form action="kullanici_hesap_kontrol.php" class="form_left" accept-charset="utf-8" method="post">
        ...
        <div class="div_right">
            ...
            if ($profil_resim != null && $profil_resim != "") {
                ...
                <form action="kullanici_hesap_kontrol.php" accept-charset="utf-8" method="post" enctype="multipart/form-data">
        ...
        <h1 style="clear:both">
            <?php
            if(isset($_SESSION['kullanici_guncelleme_mesaj'])){
                echo $_SESSION['kullanici_guncelleme_mesaj'];
                $_SESSION['kullanici_guncelleme_mesaj'] = null;
            }
            ?>
        </h1>
    </div>
