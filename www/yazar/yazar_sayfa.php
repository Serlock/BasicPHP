...
<body>
    ...
    <div class="content">
        <label style="font-size:16px">Yazılarım | </label>

        <?php

        $q = "SELECT * FROM yazilar WHERE kullanici_id=$id";
        ...
        if ($kullanicilar = $conn->query(($q))) {
            while ($row = mysqli_fetch_array($kullanicilar)) {
                ...
                echo $table_second =
                    ...
                    <td class='td_table'><a href='yazar_yazi_sil.php?id=$kitap_id' style='text-decoration:underline'>Yazıyı Sil</a></td>
