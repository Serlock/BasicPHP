...
<body>
    <div class="container">
        <form action="yazar_kayit_kontrol.php" accept-charset="utf-8" method="post" enctype="multipart/form-data">
            <div class="giris">
                <h2>Kayıt Ol - Yazar</h2>
            </div>
            ...
            <div>
                ...
                <div class="a_kaydol_div">
                    <a class="a_kaydol" href="yazar_giris.php">Giriş</a>
                </div>
                <div class="textbox_div">
                    <?php
                    session_start();
