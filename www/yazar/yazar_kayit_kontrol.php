...
if ($_POST) {
    ...
    if (strpos($kayit_eposta, 'gmail') == false) {
        ...
        session_start();
        $_SESSION['mesaj'] = $hata;
        header("Location: yazar_kayit.php", true, 301);
    }
    if ($hata == "") {
        ...
        if ($result = $conn->query($query)) {
            ...
            if ($row > 0) {
                ...
                if ($file == 1) {
                    $sql = "INSERT INTO kullanicilar (k_adi, adi, soyadi, eposta, sifre, resim, yetki) VALUES ('$kayit_k_adi', '$kayit_adi', '$kayit_soyadi', '$kayit_eposta', '$kayit_sifre', '$hedef_klasor', '2')";
