...
<body>
    ...
    <div class="content">
        <div class="div_title">
            ...
            <form action="admin_hesap_kontrol.php" class="form_left" accept-charset="utf-8" method="post">
        ...
        <div class="div_right">
            ...
            if ($profil_resim != null && $profil_resim != "") {
                ...
                <form action="admin_hesap_kontrol.php" accept-charset="utf-8" method="post" enctype="multipart/form-data">
        ...
        <h1 style="clear:both">
            <?php
            if(isset($_SESSION['admin_guncelleme_mesaj'])){
                echo $_SESSION['admin_guncelleme_mesaj'];
                $_SESSION['admin_guncelleme_mesaj'] = null;
            }
            ?>
        </h1>
    </div>
