...
<body>
    ...
    <div class="content">
        <label style="font-size:16px">Yazarlar | </label>

        <?php

        $q = "SELECT * FROM kullanicilar WHERE yetki = 2";
                ...
                echo $table_second =
                    ...
                    <td class='td_table'> $yetki - 
                        <form action='yetki_degistir.php' method='post'><label style='font-size:16px; font-weight:bold; margin:5px 0'>Yetki Değiştir:</label>
                            ...
                            <input type='hidden' name='id' value='$k_id-2'>
                    ...
                    <td class='td_table'><a href='kullanici_sil.php?id=$k_id-2' style='text-decoration:underline'>Kullanıcıyı Sil</a></td>
                    </tr>";
                $array[] = $table_second;
            }
        }
